...
- Name: api/tests/patient/onboarding/patient.getAdsLocations.spec.js >> GraphQL: Patient Get Ads Locations >> PHARMA-287 | Should NOT be able to get ads locations with invalid auth tokens
- Location: api/tests/patient/onboarding/patient.getAdsLocations.spec.js:50:7
