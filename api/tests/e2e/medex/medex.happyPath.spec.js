...
test.describe('GraphQL E2E Workflow: MedEx Happy Paths', () => {
  ...
  test(
    'PHARMA-597 | MedEx happy path with Senior Card from patient order to rider completion',
    {
  ...
  test(
    'PHARMA-598 | MedEx happy path with Senior Card and RX from patient order to rider completion',
    {
